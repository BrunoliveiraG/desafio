...
describe('Blog e2e test', () => {
  ...
  it('should load Blogs', async () => {
    ...
    expect(await blogComponentsPage.getTitle()).to.eq('desafioApp.blog.home.title');
  ...
  it('should load create Blog page', async () => {
    ...
    expect(await blogUpdatePage.getPageTitle()).to.eq('desafioApp.blog.home.createOrEditLabel');
  ...
  it('should delete last Blog', async () => {
    ...
    expect(await blogDeleteDialog.getDialogTitle()).to.eq('desafioApp.blog.delete.question');
